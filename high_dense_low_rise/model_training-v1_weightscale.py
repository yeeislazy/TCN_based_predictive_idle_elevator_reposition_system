...
import os
from torch.optim.lr_scheduler import SequentialLR, LinearLR, CosineAnnealingWarmRestarts, ChainedScheduler
...
train_dir = "high_dense_low_rise_trainset.csv"
test_dir = "high_dense_low_rise_testset.csv"
...
model.load_state_dict(torch.load(current_file_dir / 'best_recall_model_model_training-v2_restart_noweightclamp_weight_0.75_31.pth'))
model.to(device)
