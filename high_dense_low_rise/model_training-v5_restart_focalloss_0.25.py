...
model.load_state_dict(torch.load(current_file_dir / 'best_precision_model_model_training-v5_restart_focalloss_alpha_0.25_34.pth'))
model.to(device)
...
log_dir = f"restart_focalloss_alpha{alpha}"
