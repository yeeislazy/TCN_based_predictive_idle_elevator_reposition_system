...
train_dir = "low_dense_high_rise_trainset.csv"
test_dir = "low_dense_high_rise_testset.csv"
...
resp = requests.post("https://www.autodl.com/api/v1/wechat/message/send",
                     json={
                         "title": f"train_done, used time {total_used_time}, loss {test_loss}",
                         "name": f"train_done, used time {total_used_time}, loss {test_loss}",
